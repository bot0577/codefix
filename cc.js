 ...
 */
        ...
        function or(e, n) {
         ...
         var count_sSTR;
          var sSTR;
         if(sSTR!=n.containerInfo.outerText){//打开计数开关
    		count_sSTR=10;
    		sSTR = n.containerInfo.outerText;
   	 }   
          
	        if( sSTR.includes("Regenerate response", 0)== true && count_sSTR==10){
	          console.log(n.containerInfo.outerText);	
	           count_sSTR++;
			}
       
   	 if(sSTR!=n.containerInfo.outerText){
